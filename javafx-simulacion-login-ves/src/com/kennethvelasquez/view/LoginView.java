...
public class LoginView extends BorderPane{
    ...
    private String RUTA_ESTILOS = "/com/kennethvelasquez/styles/";
    ...
    private LoginView(){
        ...
        this.setBorder( new Border(
              new BorderStroke( Paint.valueOf("#1419C9"), // Color del borde
        ...
        this.setBackground( new Background(
              new BackgroundFill(Color.WHITESMOKE, //Color del fondo
